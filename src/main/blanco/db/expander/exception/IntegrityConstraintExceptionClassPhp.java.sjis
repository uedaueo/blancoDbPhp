 ...
 * @author IGA Tosiki
 */
public class IntegrityConstraintExceptionClassPhp {
    /**
     * 例外クラスのクラス名
     */
    ...
    public IntegrityConstraintExceptionClassPhp(
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("データベース制約違反に関する例外クラス");
...

        {
            final BlancoCgField cgField = fCgFactory.createField(
                    "SQLSTATE_INTEGRITYCONSTRAINT", "string",
