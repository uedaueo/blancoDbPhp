 ...
 * @author IGA Tosiki
 */
public class NoRowFoundExceptionClassPhp {
    /**
     * 例外クラスのクラス名
     */
    ...
    public NoRowFoundExceptionClassPhp(final BlancoCgObjectFactory cgFactory,
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("データベースの処理の結果、1行もデータが検索されなかったことを示す例外クラス");
...

        {
            final BlancoCgField cgField = fCgFactory.createField(
                    "SQLSTATE_NOROWFOUND", "string", null);
...

        {
            ...
            cgMethod
                    .setSuperclassInvocation("parent::__construct($reason . self::SQLSTATE_NOROWFOUND)");
        }
